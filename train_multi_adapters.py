    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if epoch == first_epoch and step == 0:
                ...
                # mask = batch['face_masks']==0
                # pixel_values[mask.repeat(1,3,1,1)] = 0
                if not image_finetune:
            ...
            with torch.no_grad():
                ...
                # zero_embedding = np.zeros_like(encoder_hidden_states)
            ...
            if is_main_process and (global_step % validation_steps == 0 or global_step in validation_steps_tuple):
                ...
                # f,c,h,w
                test_adapter_features = model_adapter(torch.concat((frames_ldmks, torch.zeros_like(frames_ldmks)),dim=1))
