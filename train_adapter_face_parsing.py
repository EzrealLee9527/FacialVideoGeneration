    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            # adapter
            unet.zero_grad()
            adapter_input = batch['face_parsings']
            # if image_finetune:
            ...
            if is_main_process and (global_step % validation_steps == 0 or global_step in validation_steps_tuple):
                ...
                #
                face_parsing_file_path = '/dataset00/Videos/collected_emotions_gif_face_parsing/smile/asia_girl_smile_1/label.npy'
                face_parsing_array = np.load(face_parsing_file_path)
                face_parsings = face_parsing_array[:1]
                ...
                # f,c,h,w
                test_adapter_features = model_adapter(face_parsings)
