...
import sys
sys.path.append('/work00/AnimateDiff')
...
class WebVid10M(Dataset):
    ...
    def get_batch(self, idx):
        ...
        video_dir = os.path.join(self.video_folder, 'videos', page_dir, f"{videoid}.mp4")
        ...
        pixel_values = torch.from_numpy(video_reader.get_batch(
            batch_index).asnumpy()).permute(0, 3, 1, 2).contiguous()
...
if __name__ == "__main__":
    ...
    dataset = WebVid10M(
        csv_path="/dataset00/Videos/webvid/results_2M_train.csv",
        video_folder="/dataset00/Videos/webvid/results_10M_train_10",
        sample_size=256,
